...
export default function Home() {
  return (
    <>
      <Head>
        <title>LeetChess | Better Way to Learn Chess</title>
        <meta
          name="description"
          content="Enhance your chess skills with LeetChess - the innovative online platform for fully interactive chess lessons. Join now and take your skills to the next level."
        />
      </Head>
