    ...
    >
      <NavigationMenu.List className="flex items-center gap-2">
        {items.map((item, idx) => (
          <NavigationMenu.Item
            key={item.href}
            className={cn("text-sm font-medium text-neutral-400")}
          >
            {item.megaMenu ? (
              <>
                ...
                >
                  <ul
                    className={cn(
                      ...
                      "sm:w-96 sm:grid-cols-2"
                    )}
                  >
                    <li
                      className={cn(
                        "select-none p-2 text-center",
                        "border-b-2 border-b-neutral-700",
                        "sm:col-span-2"
                      )}
                    >
                    ...
                    {item.megaMenu.items.map(
                      (megaMenuItem, megaMenuItemIdx) => (
        ...
        <NavigationMenu.Indicator
          className={cn("flex h-3 justify-center", "duration-200 ease-out")}
        >
          <div
            className={cn(
