          ...
          <NavigationMenu.Item className="group">
            <NavigationMenu.Link
              className={cn(
                ...
                'hidden select-none sm:inline-block',
                'rounded-2xl px-2 py-1 sm:px-3',
              ...
              {item.megaMenu ? (
                <>
                  <NavigationMenu.Trigger
                    className={cn(
                      'group flex items-center gap-1 rounded-2xl px-2 py-1 sm:px-3',
                      'hover:bg-neutral-700/50 hover:text-neutral-50',
                      'transition-colors duration-100',
                        ...
                        <li key={megaMenuItemIdx} className="">
                          <NavigationMenu.Link
                            className={cn(
                              ...
                              'rounded-2xl px-2 py-1 text-sm sm:px-3',
